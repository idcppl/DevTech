...
public class TallRecipeMap extends RecipeMap<SimpleRecipeBuilder> {
    public TallRecipeMap(String unlocalizedName, int minInputs, int maxInputs, int minOutputs, int maxOutputs, int minFluidInputs,
